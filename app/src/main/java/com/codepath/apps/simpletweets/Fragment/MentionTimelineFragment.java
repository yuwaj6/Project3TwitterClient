...
public class MentionTimelineFragment extends TweetsListFragment implements ComposeFragment.ComposeFragmentListner {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("debug","MentionTimelineFragment::OnCreated");
        populateTimeline(0);
    }
    ...
    public void populateTimeline(final long maxId) {
        client.getMentionsTimeLine(maxId, new JsonHttpResponseHandler(){
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONArray json) {
                ...
                Log.d("debug","MentionTimelineFragment::populateTimeline Success");
            }
